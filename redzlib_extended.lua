	...
	Themes = {
		Green2 = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(30, 255, 20)),
		...
		Red = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(245, 0, 0)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(60.5, 0, 0)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(245, 0, 0))
			}),
		...
		Green = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(12.5, 12.5, 12.5)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 255, 0))
			}),
			["Color Hub 2"] = Color3.fromRGB(30, 30, 30),
			["Color Stroke"] = Color3.fromRGB(40, 40, 40),
		...
		Blue = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 30, 60)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 150, 255))
			}),
			["Color Hub 2"] = Color3.fromRGB(35, 35, 45),
			["Color Stroke"] = Color3.fromRGB(50, 50, 65),
		...
		Purple = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(200, 0, 255)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(40, 0, 50)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(200, 0, 255))
			}),
			["Color Hub 2"] = Color3.fromRGB(40, 30, 45),
			["Color Stroke"] = Color3.fromRGB(60, 50, 65),
			["Color Theme"] = Color3.fromRGB(200, 0, 255),
			["Color Text"] = Color3.fromRGB(245, 245, 245),
			["Color Dark Text"] = Color3.fromRGB(190, 190, 190)
		},
		Orange = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 150, 0)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(60, 30, 0)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 150, 0))
			}),
			["Color Hub 2"] = Color3.fromRGB(45, 40, 35),
			["Color Stroke"] = Color3.fromRGB(65, 55, 50),
			["Color Theme"] = Color3.fromRGB(255, 150, 0),
			["Color Text"] = Color3.fromRGB(245, 245, 245),
			["Color Dark Text"] = Color3.fromRGB(190, 190, 190)
		},
		Pink = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(60, 20, 40)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 100, 200))
			}),
			["Color Hub 2"] = Color3.fromRGB(45, 35, 40),
			["Color Stroke"] = Color3.fromRGB(65, 50, 60),
			["Color Theme"] = Color3.fromRGB(255, 100, 200),
			["Color Text"] = Color3.fromRGB(245, 245, 245),
			["Color Dark Text"] = Color3.fromRGB(190, 190, 190)
		},
		Cyan = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 50, 50)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 255, 255))
			}),
			["Color Hub 2"] = Color3.fromRGB(30, 40, 40),
			["Color Stroke"] = Color3.fromRGB(45, 60, 60),
		...
		Yellow = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(50, 50, 0)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 0))
			}),
			["Color Hub 2"] = Color3.fromRGB(40, 40, 30),
			["Color Stroke"] = Color3.fromRGB(60, 60, 45),
		...
		Ocean = {
			...
			["Color Hub 2"] = Color3.fromRGB(30, 35, 45),
			["Color Stroke"] = Color3.fromRGB(45, 50, 65),
...
function redzlib:MakeWindow(Configs)
	...
	local WTheme = Configs[4] or Configs.Theme or redzlib.Save.Theme
	
	-- Set theme if provided and valid
	if WTheme and redzlib.Themes[WTheme] then
	...
	function Window:Notify(Text, Duration)
		local NotifyText = tostring(Text or "Notification")
		local NotifyDuration = tonumber(Duration) or 3
		
		-- Create notification UI
		local Notification = Create("Frame", ScreenGui, {
			Size = UDim2.new(0, 300, 0, 60),
			Position = UDim2.new(1, -310, 1, -70),
			BackgroundColor3 = Color3.fromRGB(30, 30, 30),
			BorderSizePixel = 0
		})
		Make("Corner", Notification, UDim.new(0, 6))
		Make("Stroke", Notification)
		
		local NotifText = Create("TextLabel", Notification, {
		...
		CreateTween({Notification, "Position", UDim2.new(1, -310, 1, -70), 0.3})
		
		-- Wait and slide out
		task.delay(NotifyDuration, function()
			CreateTween({Notification, "Position", UDim2.new(1, 10, 1, -70), 0.3})
			task.wait(0.3)
